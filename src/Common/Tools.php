...
namespace HaDDeR\NfseCoplan\Common;
...
use HaDDeR\NfseCoplan\Common\Soap\SoapInterface;
use HaDDeR\NfseCoplan\Common\Soap\SoapCurl;
...
class Tools
{
     ...
     * @throws Exception
     */
    public function send(string $message, string $operation)
    {
